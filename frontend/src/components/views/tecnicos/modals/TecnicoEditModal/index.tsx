...
export function TecnicoEditModal({ open, technician, onClose, onSaved }: Props) {
  ...
  async function handleSave() {
    ...
    try {
      ...
      // ── ORDEM CORRETA: fecha primeiro, depois avisa o pai ──────────────────
      onClose();   // 1. fecha modal
      onSaved();   // 2. pai recarrega a tabela
    } catch (err: any) {
