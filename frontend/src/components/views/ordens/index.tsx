...
export default function OrdensPage() {
  ...
  const columns: Column<OS>[] = [
    ...
    },
    {
      ...
      render: (os) => (
        <ActionButtons>
          <ActionBtn title="Ver detalhes" $variant="details" onClick={e => { e.stopPropagation(); }}>
            <IconDetails />
          </ActionBtn>
          <ActionBtn title="Editar" $variant="edit" onClick={e => { e.stopPropagation(); }}>
            <IconEdit />
          </ActionBtn>
          <ActionBtn title="Excluir" $variant="delete" onClick={e => { e.stopPropagation(); }}>
            <IconTrash />
          </ActionBtn>
        </ActionButtons>
      ),
  ...
  return (
    <AppLayout>
      ...
      <HeaderRow>
        ...
        <Button variant="login" onClick={openModal}>+ Nova OS</Button>
      </HeaderRow>
